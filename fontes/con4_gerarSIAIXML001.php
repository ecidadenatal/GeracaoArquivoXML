...
<!--            <tr>
        ...
        <fieldset id='field-arquivos'>
          ...
          <table id='arquivos'>
            ...
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo07' value='Anexo07' name="Anexo07" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo07">Anexo 07</label>
              </td>
            </tr>
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo08' value='Anexo08' name="Anexo08" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo08">Anexo 08</label>
              </td>
            </tr>
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo09' value='Anexo09' name="Anexo09" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo09">Anexo 09</label>
              </td>
            </tr>
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo10' value='Anexo10' name="Anexo10" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo10">Anexo 10</label>
              </td>
            </tr>
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo11' value='Anexo11' name="Anexo11" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo11">Anexo 11</label>
              </td>
            </tr>
            <tr>
              <td class="alinha-td-check">
                <input  type="checkbox" id='anexo12' value='Anexo12' name="Anexo12" />
              </td>
              <td class="alinha-td-label">
                <label for="Anexo12">Anexo 12</label>
              </td>
            </tr>
          </table>
        </fieldset>
  ...
  <script type="text/javascript">
    ...
    function js_processar() {
      ...
      if(!confirm("Deseja gerar os dados selecionados?")) {
        return false;
      }
      ...
      oParam.lGeraAnexo07  = $('anexo07').checked;
      oParam.lGeraAnexo08  = $('anexo08').checked;
      oParam.lGeraAnexo09  = $('anexo09').checked;
      oParam.lGeraAnexo10  = $('anexo10').checked;
      oParam.lGeraAnexo11  = $('anexo11').checked;
      oParam.lGeraAnexo12  = $('anexo12').checked;
